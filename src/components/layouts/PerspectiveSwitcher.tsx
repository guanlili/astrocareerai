...
export function PerspectiveSwitcher() {
  ...
  return (
    <div className="group relative">
      <button
        aria-haspopup="menu"
        className="flex h-9 items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-3 text-sm text-foreground transition-colors hover:bg-primary/20"
      >
      ...
      <div className="invisible absolute right-0 top-full z-50 mt-2 w-56 rounded-2xl border border-border bg-popover p-1 opacity-0 shadow-elevate transition-all group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100">
