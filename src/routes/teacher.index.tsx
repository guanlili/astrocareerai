    ...
    <TeacherShell title="工作台" subtitle="Welcome back, 陈昊 · 字节跳动 PM">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1.4fr_1fr]">
        <div className="glass-panel rounded-xl p-6">
          <SectionTitle title="本周对话量 & 付费转化" desc="蓝色为总对话轮次，金色为转化为付费 / 预约的学员数" />
        ...
        <div className="glass-panel rounded-xl p-6">
          ...
          <div className="space-y-3">
            {students.filter((s) => s.intent === "high").map((s) => (
              <div key={s.id} className="flex items-center gap-3 rounded-md border border-border bg-surface/40 p-3">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <div className="glass-panel rounded-xl p-6">
          ...
          <div className="space-y-3">
            <Row k="知识库版本" v="v3 · 2026-06-16" />
            <Row k="素材条目" v="142 项" />
            <Row k="风格调优" v="温和·术语化·中详细" />
            <Row k="转人工触发" v="3 条规则启用" />
          </div>
        ...
        <div className="glass-panel rounded-xl p-6">
          ...
          <div className="mt-1 font-mono text-xs text-muted-foreground">较上月 +22% · 平台分成 30%</div>
